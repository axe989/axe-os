...
export default function ListingMatchRowActions({ matchId }: { matchId: string }) {
      ...
      {showManualInput ? (
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            onClick={() => sendAction({ action: "set_commercial_product", commercialProductId: manualId })}
